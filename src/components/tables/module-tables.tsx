...
// /**
//  * GRITable 컴포넌트 - 현재 직접 사용되지 않음
//  * (대신 /app/(dashboard)/GRI/(tables)/griTable.tsx 파일의 GriTable 컴포넌트가 사용되고 있음)
//  *
...
// /**
//  * IFRSGovernanceTable 컴포넌트 - 현재 직접 사용되지 않음
//  *
...
// /**
//  * IFRSStrategyTable 컴포넌트 - 현재 직접 사용되지 않음
//  *
...
// /**
//  * IFRSGoalTable 컴포넌트 - 현재 직접 사용되지 않음
//  *
