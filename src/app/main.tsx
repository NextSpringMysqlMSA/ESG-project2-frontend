export default function Main() {
  return (
    <div className="flex flex-row w-full h-full max-w-screen-xl py-16">
      <div className="flex flex-col w-[50%] h-full p-4 space-y-4">
        ...
        <div className="flex flex-col w-full h-full p-8 space-y-4 bg-white shadow rounded-xl">
          ...
          <img src="/images/supplyChain.gif" alt="공급망" className="border rounded-xl" />
        </div>
      </div>
      <div className="flex flex-col w-[50%] h-full p-4 space-y-4 mt-36">
        <div className="flex flex-col w-full h-full p-8 space-y-4 bg-white shadow rounded-xl">
