...
export default function Account() {
  ...
  return (
    <div className="flex flex-col w-full bg-[#F9FBFF] px-4 py-8">
      ...
      {/* 프로필 + 개인정보 입력 영역 */}
      <div className="flex flex-row gap-20 items-start w-full max-w-4xl mx-auto">
        {/* 왼쪽 프로필 */}
          ...
          <div className="flex flex-col gap-3">
            ...
            <div>
              <label className="block mb-1 text-base font-medium text-gray-700">
                이름: <span className="font-normal text-gray-600">김지현</span>
              </label>
            </div>
            ...
            <div>
              <label className="block mb-1 text-base font-medium text-gray-700">
                이메일:{' '}
                <span className="font-normal text-gray-600">jh123@google.com</span>
              </label>
            </div>
            ...
            <div>
              <label className="block mb-1 text-base font-medium text-gray-700">
                전화번호: <span className="font-normal text-gray-600">010-1234-5678</span>
              </label>
            </div>
            ...
            <div>
              <label className="block mb-1 text-base font-medium text-gray-700">
                회사명: <span className="font-normal text-gray-600">애플코리아</span>
              </label>
            </div>
            ...
            <div>
              <label className="block mb-1 text-base font-medium text-gray-700">
                직급: <span className="font-normal text-gray-600">부장</span>
              </label>
            </div>
