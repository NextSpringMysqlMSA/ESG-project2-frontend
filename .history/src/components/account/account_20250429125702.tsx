...
export default function Account() {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen w-full bg-[#F9FBFF] px-4 py-8">
      {/* 화살표 버튼 */}
      ...
      {/* 프로필 + 개인정보 입력 영역 */}
      <div className="flex flex-row gap-20 items-center w-full max-w-4xl">
        {/* 왼쪽: 프로필 */}
