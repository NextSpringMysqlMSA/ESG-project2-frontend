...
export default function Account() {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-[#F9FBFF] px-4 py-8">
      ...
      {/* 프로필 + 개인정보 입력 영역 */}
      <div className="flex flex-col md:flex-row gap-20 items-center w-full max-w-4xl mx-auto">
        {/* 왼쪽 프로필 */}
        <div className="flex flex-col items-center gap-6 md:w-1/3 w-full pt-6">
        ...
        {/* 오른쪽 개인정보 입력폼 */}
        <div className="flex flex-col justify-between md:w-2/3 w-full h-full">
