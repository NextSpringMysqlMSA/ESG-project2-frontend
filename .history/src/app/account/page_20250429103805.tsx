      ...
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl">
        ...
        <div className="flex flex-col items-center gap-4 mb-6">
          ...
          <button
            ...
            className="px-6 py-2 bg-customG text-white rounded-full hover:opacity-90 transition-all duration-200">
            프로필 변경
          </button>
        </div>
        ...
        <div className="flex justify-end mt-6">
          <button
            ...
            className="px-8 py-3 bg-customG text-white text-lg rounded-lg hover:opacity-90 transition-all duration-200">
            저장
          </button>
        </div>
      </div>
